...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.edit_avatar_camera_icon).setOnClickListener(v -> pickImageLauncher.launch("image/*"));
            ...
            public void onResponse(Call<List<User>> call, retrofit2.Response<List<User>> response) {
                ...
                if (response.isSuccessful() && response.body() != null && !response.body().isEmpty()) {
                    ...
                    if (user.getName() != null && !user.getName().trim().isEmpty()) {
                        editAvatarInitial.setText(String.valueOf(user.getName().trim().charAt(0)).toUpperCase());
                    }
    ...
    private void uploadPhoto(Uri uri) {
        ...
        try {
            ...
            String uploadUrl = SupabaseConfig.BASE_URL + "storage/v1/object/avatars/" + fileName;
            ...
            if (response.isSuccessful()) {
                ...
                String publicUrl = SupabaseConfig.BASE_URL + "storage/v1/object/public/avatars/" + fileName;
